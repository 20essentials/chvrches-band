...
const nameBand = 'CHVRCHES';

let nameSongs = [
	"THE MOTHER WE SHARE", /*1*/
	"LEAVE A TRACE", /*2*/
	"CLEAREST BLUE", /*3*/
	"EMPTY THREAT LYRICS", /*4*/
	"BOW DOWN", /*5*/
	"MAKE THEM GOLD LYRICS", /*6*/
	"PLAYING DEAD", /*7*/
	"DOWN SIDE OF ME", /*8*/
	"UP IN ARMS", /*9*/
	"WONDERLAND", /*10*/
	...
	"BURY IT", /*13*/
	"SCIENCE/VISIONS", /*14*/
	"KEEP YOU ON MY SIDE", /*15*/
	"NOW IS NOT THE TIME", /*16*/
	"TETHER", /*17*/
	"LIES", /*18*/
	"NEVER ENDING CIRCLES", /*19*/
	"DEATH STRANDING", /*20*/
]
